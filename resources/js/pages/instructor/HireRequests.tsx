        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="relative min-h-full space-y-6 p-4 text-slate-100 selection:bg-[#3b82f6]/30 selection:text-white sm:p-6 lg:p-8">
                ...
                <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    ...
                    <div className="flex items-center gap-2 rounded-full border border-sky-500/30 bg-sky-950/30 px-4 py-1.5 text-xs font-semibold text-[#8acbff]">
                ...
                {hireRequests.length === 0 ? (
                    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/10 bg-slate-950/20 px-4 py-16 text-center">
                        <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl border border-[#38bdf8]/30 bg-gradient-to-br from-[#0284c7]/20 to-[#38bdf8]/10 text-[#38bdf8]">
                            <Briefcase className="h-7 w-7" />
                        </div>
                        <h3 className="text-base font-bold text-white">No School Hire Offers Yet</h3>
                    ...
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                        {hireRequests.map((req) => {
                            ...
                            return (
                                <div
                                    key={req.id}
                                    className="flex flex-col justify-between rounded-2xl border border-white/10 bg-white/[0.05] p-5 shadow-xl backdrop-blur-xl transition hover:border-white/20 sm:p-6"
                                >
                                    <div className="space-y-4">
                                        {/* School Title & Status */}
                                        <div className="flex items-start justify-between gap-3">
                                            <div className="flex items-center gap-3">
                                                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-sky-500/40 bg-sky-950/60 text-[#38bdf8] shadow-md">
                                        ...
                                        <div className="grid grid-cols-2 gap-3 rounded-xl bg-slate-950/40 p-3 text-xs">
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <span className="mt-0.5 flex items-center gap-1 font-extrabold text-emerald-400">
                                        ...
                                        {req.message && (
                                            <div className="text-xs text-slate-300">
                                                <span className="font-semibold text-slate-400">School Note: </span>
                                                "{req.message}"
                                            </div>
                                        )}
                                        ...
                                        {isCountered && req.counter_rate && (
                                            <div className="rounded-xl border border-sky-500/30 bg-sky-950/30 p-2.5 text-xs text-sky-200">
                                    ...
                                    {isPending && (
                                        <div className="mt-5 flex flex-wrap items-center justify-end gap-2 border-t border-white/10 pt-4">
                                            <button
                                                ...
                                                className="rounded-xl border border-white/15 bg-white/[0.06] px-3 py-2 text-xs font-semibold text-slate-200 transition hover:bg-white/10"
                                            >
                                                Counter-Offer
                                            </button>
                                            ...
                                            <button
                                                ...
                                                className="rounded-xl border border-rose-500/30 bg-rose-500/10 px-3 py-2 text-xs font-bold text-rose-300 transition hover:bg-rose-500/20 disabled:opacity-50"
                                            >
                                                Decline
                                            </button>
            ...
            {counterModalRequest && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4 backdrop-blur-md">
                    <div className="relative w-full max-w-md rounded-2xl border border-white/20 bg-[#070b12] p-6 shadow-2xl text-slate-100">
                        <button
                            type="button"
                        ...
                        <form onSubmit={handleSendCounter} className="mt-4 space-y-4 text-xs">
                            <div>
                                ...
                                <div className="relative mt-1">
                                    <DollarSign className="absolute top-2.5 left-3 h-3.5 w-3.5 text-emerald-400" />
                                    <input
                                        type="number"
                                        step="0.01"
                                        required
                                        ...
                                        className="w-full rounded-xl border border-white/15 bg-slate-950/60 py-2 pr-3 pl-8 text-xs text-white focus:border-[#3b82f6] focus:outline-none"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="mt-1 w-full resize-none rounded-xl border border-white/15 bg-slate-950/60 p-3 text-xs text-white placeholder-slate-500 focus:border-[#3b82f6] focus:outline-none"
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-end gap-2 border-t border-white/10 pt-3">
                                ...
                                <button
                                    type="submit"
                                    className="inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-[#4ba9ff] to-[#1f6eff] px-4 py-2 text-xs font-bold text-white shadow-md transition hover:scale-105"
                                >
